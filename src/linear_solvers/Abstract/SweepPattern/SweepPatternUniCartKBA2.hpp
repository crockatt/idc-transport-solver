//------------------------------------------------------------------------------------------------------------
//! \file   linear_solvers/Abstract/SweepPattern/SweepPatternUniCartKBA2.hpp
//! \brief  Header file containing declaration of SweepPatternUniCartKBA2 class.
//!
//! \author Michael M. Crockatt
//! \date   March 2018
//------------------------------------------------------------------------------------------------------------

# ifndef __ABSTRACT__SWEEP_PATTERN_UNI_CART_KBA2_HPP__
# define __ABSTRACT__SWEEP_PATTERN_UNI_CART_KBA2_HPP__
...
//------------------------------------------------------------------------------------------------------------
//! \brief  Declaration of SweepPatternUniCartKBA2 class.
//!
...
class SweepOperator<OrdinateFlux>::SweepPatternUniCartKBA2 :
    public SweepOperator<OrdinateFlux>::SweepPatternUniCart
{
    ...
    //!
    friend typename SweepPattern::template SweepPatternDerivedFactory<SweepPatternUniCartKBA2>;
...
public:
    ...
    //--------------------------------------------------------------------------------------------------------
    virtual ~SweepPatternUniCartKBA2( void );
    ...
    //--------------------------------------------------------------------------------------------------------
    SweepPatternUniCartKBA2 & operator=( const SweepPatternUniCartKBA2 & ) = delete;
...
protected:
    ...
    int64_t KBA_block_size = 1;             //! Number of spatial cells in message block. Defaults to 1.
...
# endif // ifndef __ABSTRACT__SWEEP_PATTERN_UNI_CART_KBA2_HPP__
