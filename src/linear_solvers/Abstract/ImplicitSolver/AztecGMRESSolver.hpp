//------------------------------------------------------------------------------------------------------------
//! \file   linear_solvers/Abstract/ImplicitSolver/AztecGMRESSolver.hpp
//! \brief  Header file containing declaration of AztecGMRESSolver class template.
//!
//! \author Michael M. Crockatt
//! \date   March 2018
//------------------------------------------------------------------------------------------------------------

# ifndef __ABSTRACT__AZTEC_GMRES_SOLVER_HPP__
# define __ABSTRACT__AZTEC_GMRES_SOLVER_HPP__
...
//!         using AztecOO's GMRES implementation.
//!
    ...
    public ImplicitSolver<AngularFlux>
{
    ...
    //!
    friend typename ImplicitSolver<AngularFlux>::template ImplicitSolverDerivedFactory<AztecGMRESSolver>;
...
protected:
    ...
    //--------------------------------------------------------------------------------------------------------
    AztecGMRESSolver( void ) = delete;

    //--------------------------------------------------------------------------------------------------------
    //! \brief  Delete copy constructor.
    //--------------------------------------------------------------------------------------------------------
    AztecGMRESSolver( const AztecGMRESSolver<AngularFlux> & ) = delete;
...
public:
    ...
    //--------------------------------------------------------------------------------------------------------
    AztecGMRESSolver<AngularFlux> & operator=( const AztecGMRESSolver<AngularFlux> & ) = delete;
...
protected:
    ...
    std::shared_ptr<Epetra_Operator> illsp;                 //!< Epetra_Operator object for solve.
...
//------------------------------------------------------------------------------------------------------------
template< class AngularFlux >
class AztecGMRESSolver<AngularFlux>::ILLSP :
...
public:
    ...
    //--------------------------------------------------------------------------------------------------------
    ILLSP( const AztecGMRESSolver<AngularFlux> & );
...
protected:
    ...
    //!
    const AztecGMRESSolver<AngularFlux> & enc;
};


# endif // if defined (ENABLE_AZTEC_EPETRA)
# endif // ifndef __ABSTRACT__AZTEC_GMRES_SOLVER_HPP__
